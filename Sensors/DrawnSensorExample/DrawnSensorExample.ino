//Drawn Capacitive Sensor. Graphite Drawing connects to 1Mohm pull-up resistor
//Arduino Pro
//http://www.instructables.com/id/Turn-a-pencil-drawing-into-a-capacitive-sensor-for/step3/Putting-it-together/
//Works with Uno or Pro. Make sure to set LED, capSense pins appropriately

// Pin for the LED
int LEDPin = 13;

int LEDexternal = 3;  //arbitrary
...
void loop(){
  ...
  //  turn on the LED
  if (readCapacitivePin(capSensePin) > TOUCH_THRESH) {
